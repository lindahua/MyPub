...
mypub gscholar correct ENTRY_UUID --json-file correction.json --reason "Correct source typo"
mypub gscholar correction release ENTRY_UUID FIELD --reason "Source is fixed"
