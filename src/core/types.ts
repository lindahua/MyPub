...
export interface Publication extends RecordBase {
  ...
  volume?: string; issue?: string; pages?: string; article_number?: string; extra_urls: string[]; tags: string[]; notes?: string;
...
export type ScholarCorrectableField = "title" | "authors" | "venue" | "year" | "publication_date" | "volume" | "issue" | "pages" | "publisher" | "patent_office" | "application_number" | "description" | "scholar_url" | "cited_by_url" | "authors_text";
...
export interface StatusResult { changes?: StatusChange[]; catalog: "ready" | "missing"; git: boolean; lfs: boolean; branch?: string; commit?: string; upstream?: string; ahead?: number; behind?: number; dirty: boolean; pending_upload: boolean; needs_review: boolean; last_successful_sync?: string; }
