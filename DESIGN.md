...
The implemented Electron viewer provides Overview, Publications, Authors, Venues and Google Scholar pages with folder selection and inline details. Review/Sync editing screens, embedded previews and signed installers remain later work.
...
| Electron viewer: implemented | Reuse core snapshots through a worker and IPC; five pages, filters, inline details, local file opening and refresh |
